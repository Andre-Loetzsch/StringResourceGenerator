...
internal class GenerateCommand : Command
{
    ...
    public GenerateCommand(ResGen resGen) : base("generate", "Generate string resource files.")
    {
        this._resGen = resGen;
    ...
    {
        var option = new Option<FileInfo>(name: "--file", description: "The '*.strings' file to generate resources.").ExistingOnly();
