...
namespace Oleander.StrResGen.SingleFileGenerator
{
    ...
    [ProvideCodeGenerator(typeof(StrResGenCodeGenerator), nameof(StrResGenCodeGenerator), "string resource generator", true)]
    public sealed class StrResGenSingleFileGeneratorPackage : AsyncPackage
    {
        /// <summary>
        /// Oleander.StrResGen.SingleFileGeneratorPackage GUID string.
        /// </summary>
